...
mockgen:
	...
	@mockgen -destination pipeline/mock/mocks.go -package mock github.com/figment-networks/indexing-engine/pipeline PayloadFactory,Payload,Source,Sink,Stage,Task,Logger
